...
class SellerEditProfilePage extends ConsumerStatefulWidget {
  const SellerEditProfilePage({super.key, required this.sellerId});
  final String sellerId;
  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _SellerEditProfilePageState();
}

class _SellerEditProfilePageState extends ConsumerState<SellerEditProfilePage> {
  ...
  void _loadSellerDetails(SellerUiModel seller) {
    _fullNameController.text = seller.fullName;
    _emailController.text = seller.userUiModel?.email ?? "";
    _phoneNumberController.text = seller.phoneNumber ?? "";
    _bioController.text = seller.bio ?? "";
    _profilePictureUrl = seller.profilePictureUrl;
  }
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<SellerState>(sellerViewModelProvider, (previous, next) {
      ...
      } else if (next.sellerStatus == SellerStatus.updated) {
        SnackbarUtil.showSuccess(
          context,
          "User profile details updated successfully!",
        );
      } else if (next.sellerStatus == SellerStatus.imageLoaded) {
        if (_profileImage != null) {
          _profileImage = null;
        }
        ref
    ...
    _loadSellerDetails(SellerUiModel.fromEntity(sellerState.seller!));
              ...
              Container(
                ...
                child: SizedBox(
                  ...
                  child: GradientElevatedButton(
                    ...
                    child: sellerState.sellerStatus == SellerStatus.loading
                        ? const Center(
