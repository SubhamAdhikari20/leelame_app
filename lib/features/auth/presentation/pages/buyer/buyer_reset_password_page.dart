// lib/features/auth/presentation/pages/buyer/buyer_reset_passsword_page.dart
...
class BuyerResetPasswordPage extends StatefulWidget {
  const BuyerResetPasswordPage({super.key});

  @override
  State<BuyerResetPasswordPage> createState() => _BuyerResetPasswordPageState();
}

class _BuyerResetPasswordPageState extends State<BuyerResetPasswordPage> {
