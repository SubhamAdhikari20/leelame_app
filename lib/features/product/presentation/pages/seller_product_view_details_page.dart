...
class SellerProductViewDetailsPage extends ConsumerStatefulWidget {
  const SellerProductViewDetailsPage({
    super.key,
  ...
  @override
  ConsumerState<SellerProductViewDetailsPage> createState() =>
      _SellerProductViewDetailsPageState();
}

class _SellerProductViewDetailsPageState
    extends ConsumerState<SellerProductViewDetailsPage> {
  ...
  void _loadAll() {
    ...
    ref.read(sellerViewModelProvider.notifier).getCurrentUser(sellerId: widget.currentUserId);
  }
